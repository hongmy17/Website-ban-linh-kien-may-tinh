    ...
    <div class="row">
      <div class="col-sm-4">
        <form class="search-box" method="post" action="">
          <input type="text" class="form-control" name="search-box" placeholder="Tìm kiếm&hellip;" value="" />
        </form>
      </div>
          ...
          <tr class="border-bottom">
            ...
            <td>
              <div class="p-2 d-flex flex-row align-items-center mb-2">
                <img src="/upload/product/<?= $product["base_image"]; ?>" width="40" class="me-3" />
            ...
            <td>
              <div class="p-2 icons">
                <a href="/admin/product/info?id=<?= $product["id"]; ?>" class="edit text-decoration-none">
                  <i class="fas fa-info"></i>
                </a>
                <a href="/admin/product/edit?id=<?= $product["id"]; ?>" class="edit text-decoration-none">
                  <i class="fas fa-pen text-warning mx-2"></i>
                </a>
                <a href="/admin/product/delete?id=<?= $product["id"]; ?>" class="edit text-decoration-none">
